...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(context dir_writable dir vcs)  #(dir rbenv vcs nvm) 
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(background_jobs disk_usage time root_indicator) 
...
POWERLEVEL9K_DISK_USAGE_WARNING_FOREGROUND='167'
POWERLEVEL9K_DISK_USAGE_CRITICAL_FOREGROUND='202'
#POWERLEVEL9K_DISK_USAGE_WARNING_BACKGROUND="lightcoral"
#POWERLEVEL9K_DISK_USAGE_CRITICAL_BACKGROUND='red1'
POWERLEVEL9K_TIME_BACKGROUND=none
POWERLEVEL9K_TIME_FOREGROUND='138'

POWERLEVEL9K_DIR_HOME_BACKGROUND='138'
POWERLEVEL9K_DIR_HOME_SUBFOLDER_BACKGROUND='138'
POWERLEVEL9K_DIR_ETC_BACKGROUND='138'
POWERLEVEL9K_DIR_DEFAULT_BACKGROUND='138'
POWERLEVEL9K_DIR_NOT_WRITABLE_BACKGROUND='138'
...
POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='223'
POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='131'
POWERLEVEL9K_VCS_LOADING_BACKGROUND='249'
POWERLEVEL9K_VCS_CLEAN_FOREGROUND='234' 
POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='234' #'147' #139
POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='252' # rusty
POWERLEVEL9K_VCS_LOADING_FOREGROUND='252'

POWERLEVEL9K_VCS_UNTRACKED_ICON=$'%{\b?%}' # 033 is a good blue
POWERLEVEL9K_VCS_UNSTAGED_ICON=$'%{\b!%}' #197 is a good red
POWERLEVEL9K_VCS_STAGED_ICON=$'%{\b+%}'

POWERLEVEL9K_DIR_NOT_WRITABLE_VISUAL_IDENTIFIER_COLOR='bisque2'
...
POWERLEVEL9K_NVM_FOREGROUND='139' # 134
